...
/// A generator with nowhere to send anybody, for the one that arrives without
/// a tap: the room importer's doorways. Not white, because white is what an
/// ordinary wall nearly is, and an unaimed generator should read as unfinished
/// rather than as a fresh wall. It takes its goal's colour the moment it is
/// aimed, as the people coming out of it do.
public let GENERATOR_GREY: RGB = (150, 150, 160)
